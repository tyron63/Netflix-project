  ...
  validate = () => {
    ...
    if (this.state.password.length < 4) {
      ...
      errors.passwordError =
        'Your password must contain between 4 to 60 charaters';
    }
      ...
      <FormContainer>
        <div className="form-container">
          <form>
            ...
            <div className="input-container">
              <Button type="sumbit" onClick={(e) => this.onSubmit(e)}>
                Sign In
              </Button>
            </div>
            ...
            <Link className="need-help">Need Help</Link>
